...
public class StudentControllerTest {
    ...
    public void testPostStudent() throws Exception {
        StudentDeptCourse student = new StudentDeptCourse();

        when(studentService.postStudent(any(StudentDeptCourse.class))).thenReturn("Success");
    ...
    public void testGetAllStudents() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/getStudentList")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }
    ...
    public void testDeleteStudent() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/deleteStudent/1"))
                .andExpect(status().isOk());
    }
    ...
    public void testGetStudentById() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/getStudentByID/1"))
                .andExpect(status().isOk());
    }
    ...
    public void testGetStudentInfo() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/getStudentInfo/1"))
                .andExpect(status().isOk());
    }
    ...
    public void testGetStudentsByFirstName() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/students?first_name=John"))
                .andExpect(status().isOk());
    }
